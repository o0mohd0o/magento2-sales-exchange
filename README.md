...
> **Release status:** `0.2.2` is the latest pre-1.0 release. The source has
...
At this source state, local evidence comprises 388 passing unit tests with 1,052
...
Magento Open Source 2.4.8 integration tests with 31
